...
GeckoMain   3709 chrism   35u  IPv4 1459778      0t0  TCP x.x.x.x:53930->x.x.x.x:https (ESTABLISHED)
GeckoMain   3709 chrism   81u  IPv4 1396602      0t0  TCP x.x.x.x:55684->x.x.x.x:https (ESTABLISHED)
GeckoMain   3709 chrism 3380u  IPv4 1433281      0t0  TCP x.x.x.x:47824->x.x.x.x:https (ESTABLISHED)
GeckoMain   3709 chrism 3408u  IPv4 1283481      0t0  UDP *:mdns
multiple_ 107620 chrism   10u  IPv4 1459902      0t0  TCP 127.0.0.1:25000 (LISTEN)
multiple_ 107620 chrism   39u  IPv4 1459903      0t0  TCP 127.0.0.1:59464->127.0.0.1:25000 (ESTABLISHED)
multiple_ 107620 chrism   46u  IPv4 1459904      0t0  TCP 127.0.0.1:25000->127.0.0.1:59464 (ESTABLISHED)
```
